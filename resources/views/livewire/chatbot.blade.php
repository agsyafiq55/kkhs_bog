<div class="fixed bottom-6 right-6 z-50 w-80 bg-white dark:bg-zinc-900 shadow-xl rounded-2xl overflow-hidden border border-gray-100 dark:border-zinc-800 flex flex-col transition-all duration-300 ease-in-out" style="{{ $isCollapsed ? 'max-height: 48px;' : 'max-height: 500px;' }}">
