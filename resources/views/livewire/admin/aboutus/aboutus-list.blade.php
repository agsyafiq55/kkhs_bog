            ...
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-zinc-700">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="flex justify-center space-x-2 mt-4">
                                            ...
                                            <flux:modal name="delete-member-{{ $member->id }}" class="min-w-[22rem]">
                                                <form wire:submit.prevent="deleteMember({{ $member->id }})">
                                                    <div class="space-y-6">
                                                        <div>
                                                            <flux:heading size="lg">Delete Member?</flux:heading>
                                                            <flux:text class="mt-2">
                                                                <p>You're about to delete {{ $member->member_name }}.</p>
                                                        ...
                                                        <div class="flex gap-2">
                                                            ...
                                                            <flux:button type="submit" variant="danger">Delete Member</flux:button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </flux:modal>
                ...
                @else
                    <div class="text-center py-12 bg-gray-50 dark:bg-zinc-900 rounded-lg">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-gray-100">No board members found
                        </h3>
