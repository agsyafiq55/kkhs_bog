<div class="bg-white dark:bg-zinc-900 py-12">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
            <div class="space-y-6 bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800">
                <div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-300">
                        <a href="mailto:{{ $contactUs->email }}" class="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
                            {{ $contactUs->email }}
                        </a>
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-300">
                        <a href="tel:{{ $contactUs->phone_no1 }}" class="block text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
                            {{ $contactUs->phone_no1 }}
                        </a>
                        @if($contactUs->phone_no2)
                        <a href="tel:{{ $contactUs->phone_no2 }}" class="block text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
                            {{ $contactUs->phone_no2 }}
                        </a>
                        @endif
                    </p>
            ...
            <div class="h-96 bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800">
