        ...
        <div class="relative h-screen w-full">
            ...
            <div class="flex h-full items-center justify-center">
                <div x-data="{ show: false }"
                    ...
                    class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl transition-all duration-1000 ease-out hover:text-indigo-300 hover:scale-105 cursor-pointer"
                        x-bind:class="show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'">
                        KKHS Board of Governors.
                    </h1>
                    <p class="mt-8 text-lg font-medium text-gray-300 sm:text-xl transition-all duration-1000 delay-300 ease-out hover:text-white hover:translate-y-[-2px] cursor-pointer"
                        x-bind:class="show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'">
                        Preserving a Quality Education System to Develop Individual Potential to Fulfill National Aspirations.
                    </p>
                    <div class="mt-10 flex items-center justify-center gap-x-6 transition-all duration-1000 delay-500 ease-out"
                        x-bind:class="show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'">
                        <a href="#" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
                            Get started
                        </a>
                        <a href="#" class="text-sm font-semibold text-gray-300">
