<x-layouts.app>
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="md:flex">
                ...
                <div class="md:w-1/3 p-6">
                    <h1 class="text-2xl font-bold mb-2">{{ $image->img_name }}</h1>
        ...
        @if($relatedImages->isNotEmpty())
            <div class="mt-12">
                <h2 class="text-xl font-semibold mb-6">More from {{ $image->category }}</h2>
                    ...
                    @foreach($relatedImages as $relatedImage)
                        <a href="{{ route('gallery.show', $relatedImage->id) }}" 
                           class="block group">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">{{ $relatedImage->img_name }}</h3>
                        </a>
                    @endforeach
                </div>
            </div>
